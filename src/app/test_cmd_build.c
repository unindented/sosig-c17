...
// compares the generated bytes end to end with `tests/expected/site-file-permalink/nested`. What
...
// compares that output shape end to end with `tests/expected/site-index-permalink`. What this adds
